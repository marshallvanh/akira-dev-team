...
Marshall, I've reviewed what was just built. Here's the status:

## What's Complete ✅

- Parent dashboard PIN modal added to main dashboard
- PIN protection wired (hardcoded PIN: `1234`)
- Navigation to parent-dashboard screen configured
- Parent dashboard analytics view exists (but needs verification)

---

## What's Next — Build Order

You have **three major features** remaining. Here's the priority:

### Phase 1: Stories Library (CRITICAL PATH)
**Why first:** Your son can't read anything without it. Dashboard links to it but it doesn't exist.
- Browse all stories
- Filter by difficulty/category
- Select story → start reading
- ~20 minutes

### Phase 2: Reading Screen (CORE EXPERIENCE)
**Why second:** Where the actual learning happens.
- Display story text + audio
- Speech recognition for reading practice
- Progress tracking per story
- Reading feedback (correct/incorrect words)
- ~30 minutes

### Phase 3: Achievements + Rewards (GAMIFICATION)
**Why third:** Keeps engagement high but not critical for MVP.
...
## Critical Questions Before I Hand Off

1. **Stories data source:** Are stories stored in backend database, or hardcoded initially?
2. **Reading experience:** Do you want:
   - Text-only reading?
   - Text + audio narration?
   - Speech recognition for reading aloud?
3. **Story structure:** Do stories have:
   - Multiple chapters/weeks?
   - Difficulty levels?
   - Associated lessons/quizzes?

**I need these answers to architect the reading screen correctly.** Once you answer, I'll hand off to the workers with a complete build spec.

---

Which answers can you give me now?

---

# BACKEND

# 📚 Next Stage: Stories Library Screen

Marshall, now we build the **stories library** — the browsing interface where your son selects which story to read.

## What's Being Built

### `app/(main)/stories/index.tsx`
The main library screen with:

**Features:**
- Grid of story cards with thumbnails
- Story metadata (title, week number, difficulty level)
- Reading progress indicators (✓ completed, 🔄 in progress)
- Points earned per story
- Tap to navigate to reading screen
- Beautiful gradient cards
- Filter by completion status (optional enhancement)

**Design:**
- Colorful story cards with emojis
- Week badges (Week 1, Week 2, etc.)
- Difficulty indicators (Easy, Medium, Hard)
- Progress badges
- Smooth navigation to reading screen
...
```
🏗️ The School Foundation
Week 1 • Easy • 50 points
[Read Now →]
```

Stories will be:
1. **Week 1:** The School Foundation (Easy)
2. **Week 2:** The Classroom Wings (Easy)
3. **Week 3:** The Library Tower (Medium)
4. **Week 4:** The Science Lab (Medium)
5. **Week 5:** The Sports Field (Hard)
6. **Week 6:** The Art Studio (Hard)
7. **Week 7:** The Music Hall (Hard)
8. **Week 8:** The Grand Opening (Medium)

Each taps through to the reading screen at `app/(main)/story/[week].tsx` (which already exists).
...
The screen will:
- Fetch user's reading progress from backend
- Show completed/in-progress status
- Display earned points per story
- Track which stories are unlocked

---

**Ready to build the stories library?**

Say **yes** to continue or ask questions.

💰 *Cost: $9.7071 (139 calls this session)*