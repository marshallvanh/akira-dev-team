...
**Problem:**
- Don't know what stage we're on
- Don't know what's been completed
- Can't proceed without understanding current state

**Need from you:**
What are we building right now? What's the next step in brainy-builds?
...
---EXECUTION PLAN---
COMMANDS:
cd /home/marshall/projects/brainy-builds/backend && npm run seed
---END PLAN---